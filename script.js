...
function validate() {
    ...
    document.myForm.month.value.length !=2 || document.myForm.month.value <= 0) {
        alert("Please provide your month of birth! between 1 and 12" );
        document.myForm.month.focus() ;
        return false;
    }
    else if( document.myForm.date.value == "" || isNaN( document.myForm.month.value ) ||
    document.myForm.month.value.length !=2|| document.myForm.date.value > 31 || document.myForm.date.value > 31 || document.myForm.date.value <= 0) {
    ...
    switch(gender){
        ...
        case "female":
            if (dayValue == 1){
                ...
                alert("You were born on " +dayNames[6] + " and Your akan names is "+femaleNames[6]+"!");
            }
        break
        default:
